...
export default {
    ...
    computed: {
        ...
        tambahPajak() {
            return (this.subTotalHarga * 10) / 100;
        },
        totalHarga() {
            return this.subTotalHarga + this.tambahPajak;
        },
    },
};
</script>
...
<template>
    <div class="product">
        ...
        <BreadcrumbShayna nameLink="Shopping Cart" />
        <!-- Breadcrumb Section Begin -->
                                ...
                                <div class="proceed-checkout">
                                    <ul>
                                        ...
                                        <li class="subtotal mt-3">
                                            Subtotal <span>${{ subTotalHarga }}</span>
                                        </li>
                                        <li class="subtotal mt-3">
                                            Pajak <span>10% | ${{ tambahPajak }}</span>
                                        </li>
                                        <li class="subtotal mt-3">
                                            Total Biaya <span>${{ totalHarga }}</span>
                                        </li>
